...
class UploadJournalEntry
    implements UseCase<Map<String, Map<String, String>>, UploadJournalEntryParams> {
...
class JournalGetter implements UseCase<Map<String, Map<String, String>>, NoParameters> {
  final JournalRepository journalRepository;
